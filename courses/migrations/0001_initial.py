    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('releted_course', models.ManyToManyField(blank=True, to='courses.course', verbose_name='Releted Courses')),
            ],
        ),
        migrations.CreateModel(
            name='CourseSection',
            fields=[
                ...
                ('episodes', models.ManyToManyField(blank=True, to='courses.episode', verbose_name='Episode')),
            ],
        ),
    ]
